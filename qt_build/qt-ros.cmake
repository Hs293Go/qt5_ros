...
###############################
#
# On mingw_cross, system lib deps are in prl files which FindQt5 does not check, 
...
endmacro()
#
# Is a wrapper around FindQt5.cmake.
# 
# Mostly this is needed to satisfy a static mingw cross compile of qt, (mingw_cross)
# as the cmake FindQt5 handles this poorly. Optionally call with the components 
# you want to use, e.g.
# 
#     rosbuild_prepare_qt5()
#     rosbuild_prepare_qt5(Widgets Core)
#
# What this macro does:
#
# - calls the underlying FindQt5.cmake module with the specified components.
...
#
# Sets QT_FOUND and QT5_FOUND if QT/QT5 was found.
# Also sets QT_XXX_FOUND if the specific component (XXX) was found.
#
# See the official FindQt5.cmake module for more information (usually in 
# /usr/share/cmake-2.8/Modules/FindQt5.cmake 
#
macro(rosbuild_prepare_qt5)
    if ( ${ARGC} GREATER 0 )
        #foreach(arg ${ARGV})
        ...
        #find_package(Qt5 COMPONENTS ${QT_COMPONENTS_}) 
        #find_package(Qt5 COMPONENTS QtCore QtWidgets QtXml) 
    ...
    if(NOT QT_QMAKE_EXECUTABLE)
      #set(QT5_FOUND QT5-NOTFOUND) # Do we actually need this?
    else()
        ...
        if(QT_IS_STATIC) 
            ...
            if(QT_USE_QTGUI) 
                qt_link_flags_from_prl(QtWidgets)
            endif()
            if(QT_USE_QTMAIN) 
